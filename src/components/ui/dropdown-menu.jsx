...
const DropdownMenuSubTrigger = React.forwardRef(
  ({ className, inset, children, ...props }, ref) => (
    <DropdownMenuPrimitive.SubTrigger
      ref={ref}
      className={cn(
        "flex items-center gap-2 px-2 py-1.5 text-sm rounded-sm cursor-default hover:bg-accent",
        inset && "pl-8",
        className
      )}
      {...props}
...
const DropdownMenuCheckboxItem = React.forwardRef(
  ({ className, checked, children, ...props }, ref) => (
    <DropdownMenuPrimitive.CheckboxItem
      ref={ref}
      className={cn(
        "relative flex items-center rounded-sm py-1.5 pl-8 pr-2 text-sm hover:bg-accent",
        className
      )}
      checked={checked}
      {...props}
